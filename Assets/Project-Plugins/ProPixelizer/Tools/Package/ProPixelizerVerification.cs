...
namespace ProPixelizer
{
    ...
    public class ProPixelizerVerification
    {
        ...
        {
#if UNITY_EDITOR
            AssetDatabase.ImportAsset("Assets/Project-Plugins/ProPixelizer/ShaderGraph/ProPixelizerBase.shadergraph", ImportAssetOptions.ForceUpdate);
            AssetDatabase.ImportAsset("Assets/Project-Plugins/ProPixelizer/SRP/PixelizedWithOutline.shader", ImportAssetOptions.ForceUpdate);
#endif
        }
